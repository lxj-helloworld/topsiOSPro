...
protocol ImageSlideshowProtocol {
...
open class ImageSlideshow: UIView {
    ...
    var pagePointShow:Bool = true
    var delegate:ImageSlideshowProtocol?
...
//            循环滚动
        ...
        delegate?.currentImageIndex(index:currentPageForScrollViewPage(primaryVisiblePage))
    }
}
